...
public enum RVMessagePosition {
    case top
    case bottom
}

public enum RVMessageAnimation {
    case fade
...
public enum RVMessageTextAlignment {
    case topLeft
    case topCenter
    case topRight
    case left
...
public enum RVMessageOption {
    case accessibilityIdentifier(String)
    case animations([RVMessageAnimation])
    ...
    case position(RVMessagePosition)
    case textAlignment(RVMessageTextAlignment)
...
public class GSMessage: NSObject {
    ...
    public private(set) var animations: [RVMessageAnimation] = [.slide(.normal)]
    ...
    public private(set) var position: RVMessagePosition = .top
    public private(set) var textAlignment: RVMessageTextAlignment = .center
...
fileprivate extension RVMessageTextAlignment {
