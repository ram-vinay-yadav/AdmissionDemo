...
@objc public enum RVCircularProgressGlowMode: Int {
    case forward, reverse, constant, noGlow
}

@IBDesignable
@objcMembers
public class RVCircularProgress: UIView, CAAnimationDelegate {
    ...
    public var glowMode: RVCircularProgressGlowMode = .forward {
        didSet {
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        var glowMode: RVCircularProgressGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: RVCircularProgressGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
